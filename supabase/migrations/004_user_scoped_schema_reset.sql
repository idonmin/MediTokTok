...
create table public.chat_messages (
  ...
  created_at timestamptz not null default now(),
  constraint chat_messages_conversation_user_fk
...
create index if not exists collection_runs_user_created_idx on public.collection_runs(user_id, created_at desc);
...
create policy "users can read own collection runs"
